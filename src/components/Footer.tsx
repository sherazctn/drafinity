        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="bg-secondary/50 border border-border rounded-lg p-4">
              <p className="text-xs font-heading uppercase tracking-[0.12em] text-foreground mb-2">
                Need a Quote?
              </p>
              ...
              <Link
                to="/contact"
                className="inline-flex text-xs font-heading uppercase tracking-[0.12em] text-foreground hover:text-muted-foreground transition-colors"
              >
                Request Quote →
              </Link>
            </div>
