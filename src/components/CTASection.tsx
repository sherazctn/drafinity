    ...
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          ...
          className="absolute top-1/3 h-px w-1/2 bg-gradient-to-r from-transparent via-foreground/5 to-transparent"
        />
        <motion.div
          animate={{ x: ["150%", "-50%"] }}
          transition={{ duration: 8, repeat: Infinity, ease: "linear" }}
          className="absolute top-2/3 h-px w-1/3 bg-gradient-to-r from-transparent via-foreground/5 to-transparent"
        />
      </div>

      <div className="light-line mb-16" />
      ...
      <div className="container mx-auto px-4 lg:px-8 text-center relative z-10">
        ...
        >
          Ready to Build
          <br />
          <span className="text-gradient-highlight">Something Exceptional?</span>
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
