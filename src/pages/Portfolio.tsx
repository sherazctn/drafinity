...
const projects = [
  ...
  // Existing projects - each with unique images
  ...
  { image: reno2, title: "Waterfront Condo Tower", category: "3D Rendering", solution: "Full suite of day/night exterior renders, lobby visualization, and aerial perspectives.", tools: "3ds Max, V-Ray, Photoshop", result: "60% pre-sales before groundbreaking.", pdfUrl: "https://drive.google.com/file/d/1CtK9mYtbb_sBn-aEAq6PsDv-XmfXu8Kt/view?usp=drive_link" },
  { image: reno3, title: "Boutique Hotel Renovation", category: "Interior Visualization", solution: "Detailed room-by-room interior renderings showing material finishes and FF&E selections.", tools: "SketchUp, V-Ray, Enscape", result: "Franchise approval on first submission.", pdfUrl: "https://drive.google.com/file/d/13rvXbZ1XKfDt_EAsNpajXHm5DxBqkeDD/view?usp=drive_link" },
  ...
  { image: luxury3, title: "Coastal Resort Villas", category: "Interior Visualization", solution: "Luxury coastal villa interiors with ocean-view living spaces, custom millwork, and designer furniture layouts.", tools: "3ds Max, V-Ray, Photoshop", result: "All 24 villas sold pre-completion.", pdfUrl: "https://drive.google.com/file/d/1hMUp0S9QYiJOuAXBpvg9Y__SscFrBedn/view?usp=drive_link" },
