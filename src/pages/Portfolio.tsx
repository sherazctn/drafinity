...
const categories = ["All", "Luxury Rendering", "3D Renovation Projects", "3D Rendering", "Interior Visualization", "Construction Documents", "2D Floor Plans", "BIM Modeling", "Licensed Review Coordination"];
...
const projects = [
  ...
  { image: portfolio3, title: "Mixed-Use Development", category: "Construction Documents", solution: "Complete CD set with structural, MEP, and technical drawings prepared for licensed professional review across 3 jurisdictions.", tools: "AutoCAD, Revit, Bluebeam Revu", result: "Permits approved with zero revisions.", pdfUrl: "https://drive.google.com/file/d/1GoqE8gm4YXfv9kwxGGaTCzhau1C7uGIl/view?usp=drive_link" },
  ...
  // Licensed Review Coordination
  { image: reno7, title: "Urban Retail Center", category: "Licensed Review Coordination", solution: "Multi-jurisdiction licensed review coordination support with local code compliance documentation.", tools: "AutoCAD, Bluebeam Revu", result: "All 15 locations permitted in 60 days.", pdfUrl: "https://drive.google.com/file/d/1GeCx7SWgAGjFd1LCcQ2ciCM83aKsRW9e/view?usp=drive_link" },
  { image: reno9, title: "Restaurant Chain Expansion", category: "Licensed Review Coordination", solution: "Standardized plan set with jurisdiction-specific documentation prepared for review by the client's licensed professional.", tools: "AutoCAD, Bluebeam Revu", result: "12 business days avg. permit approval.", pdfUrl: "https://drive.google.com/file/d/1J1FMqNzAHoa3Pgc96qrRHSwpaAGdD4xT/view?usp=drive_link" },
  { image: luxury4, title: "National Bank Headquarters", category: "Licensed Review Coordination", solution: "Multi-jurisdiction documentation coordination with vault specifications, security systems, and blast-resistant design details prepared for licensed professional review.", tools: "AutoCAD, Revit, Bluebeam Revu", result: "8 branches permitted simultaneously.", pdfUrl: "https://drive.google.com/file/d/1N7qPCelI_O_MibjN7kZ1ktER_tJNZFGG/view?usp=drive_link" },
];
  ...
  return (
    <main>
      <SEO
        ...
        description="Browse Drafinity's portfolio of 500+ completed projects: residential floor plans, luxury 3D renderings, commercial BIM models, and renovation drawings for clients across the US."
        path="/portfolio"
        keywords="drafting portfolio, 3D rendering examples, BIM project gallery, drafting and BIM portfolio"
