...
const tools = [
  ...
  { id: "stair", icon: FolderUp, title: "Stair Calculator", desc: "Calculate riser count, tread depth, and total run per IRC code.", component: StairCalc, category: "Design" },
  { id: "roof", icon: Triangle, title: "Roof Pitch Calculator", desc: "Find pitch ratio, angle, and slope multiplier for roofing.", component: RoofPitchCalc, category: "Design" },
  ...
  { id: "brick", icon: Blocks, title: "Brick Calculator", desc: "Calculate number of bricks and mortar for wall construction.", component: BrickCalc, category: "Materials" },
