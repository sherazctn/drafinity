...
const featuredPartners = [
  {
    ...
    state: "New Mexico",
    license: "LIC-10000",
    address: "100 Main Street, New Mexico",
  ...
  },
  {
    ...
    state: "New York",
    license: "LIC-10137",
    address: "107 Main Street, New York",
    services: ["2D Floor Plans", "Structural Drafting", "3D Rendering", "BIM Modeling"],
    isNative: false,
  },
  {
    id: 3,
...
const Partners = () => {
  ...
  const usStates = [...new Set(featuredPartners.map((p) => p.state))];

  const filtered = featuredPartners.filter((p) => {
