...
const softwareCategories = [
  { label: "CAD & Drafting", tools: [
    { name: "AutoCAD", description: "Industry-standard 2D and 3D CAD design software. We use it for precise floor plans, site plans, and detailed construction drawings.", use: "Floor Plans, Site Plans, Details" },
    { name: "ArchiCAD", description: "Powerful BIM software for architectural design. Ideal for creating comprehensive building models with integrated documentation.", use: "Architectural Design, Documentation" },
  ]},
  { label: "BIM & Modeling", tools: [
    { name: "Revit", description: "Autodesk's BIM platform for multi-discipline coordination. Enables parametric modeling, clash detection, and automated schedules.", use: "BIM Modeling, MEP, Structural" },
  ...
  { label: "3D Visualization", tools: [
    ...
    { name: "V-Ray", description: "Professional rendering engine producing photorealistic images. Industry-leading quality for architectural visualization.", use: "Photorealistic Rendering" },
    { name: "Lumion", description: "Real-time 3D visualization software with vast material and object libraries. Perfect for quick, high-quality renderings and animations.", use: "Real-time Rendering, Animations" },
  ]},
  { label: "Documentation & Review", tools: [
    { name: "Bluebeam Revu", description: "PDF markup and collaboration tool designed for AEC professionals. Streamlines document review and quality control workflows.", use: "Plan Review, Markup, QC" },
          ...
          <div className="container mx-auto px-4 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {category.tools.map((tool, i) => (
                <motion.div key={tool.name} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="bg-secondary/30 border border-border rounded-lg p-6 card-hover">
