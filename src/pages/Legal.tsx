...
const statePermitData: StatePermitInfo[] = [
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "Stamped structural engineering plans", "MEP (Mechanical, Electrical, Plumbing) plans", "Fire protection and life safety plans", "ADA compliance documentation", "Environmental impact assessment (if required)", "Zoning compliance verification", "Parking and traffic study (if applicable)", "Stormwater management plan"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "Structural engineer-stamped calculations", "MEP drawings and specifications", "Fire marshal review and approval", "ADA compliance plans", "Energy code compliance (ASHRAE 90.1)", "Environmental review documents"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "Structural engineer-stamped plans", "MEP plans and specifications", "Fire sprinkler/suppression plans", "ADA compliance documentation", "Landscape and irrigation plans", "Traffic impact study (if required)", "ADEQ environmental clearance"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "Structural engineer-stamped documents", "MEP plans and specs", "Fire protection plans", "ADA/accessibility compliance", "Energy code compliance (IECC Commercial)", "Stormwater management plan"],
  ...
  },
  {
    ...
    commercialRequirements: ["Drawings signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-stamped structural plans", "MEP drawings", "Fire protection plans", "ADA compliance", "Environmental site assessment", "Zoning approval"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a Florida-licensed design professional", "PE-sealed structural engineering plans", "Complete MEP documents", "Fire protection plans", "Threshold inspection agreement (for threshold buildings)", "ADA compliance", "Environmental permits (DEP)", "Stormwater management plan", "Parking lot and drainage plans"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-stamped structural documents", "MEP plans", "Fire protection plans", "ADA compliance", "Environmental review", "Land disturbance permit (>1 acre)", "Stormwater management plan"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-sealed structural documents", "MEP plans and specs", "Fire protection plans", "ADA/accessibility compliance", "Environmental clearances", "Zoning verification"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-stamped structural plans", "Complete MEP plans", "Fire protection and sprinkler plans", "ADA/accessibility compliance", "Environmental assessment", "Zoning approval", "Stormwater management plan"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-sealed structural documents", "MEP plans", "Fire protection plans", "ADA compliance", "Environmental review", "Erosion control plan"],
  ...
  },
  {
    ...
    commercialRequirements: ["Ohio-certified plans examiner review", "Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-sealed structural plans", "MEP drawings", "Fire protection plans", "ADA compliance", "Ohio Industrial Compliance certification"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-sealed structural plans", "MEP documents", "Fire protection plans", "ADA compliance", "Accessibility compliance (PA UCC Chapter 11)", "Environmental clearances"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-stamped structural engineering", "Complete MEP documents", "Fire protection plans", "ADA/TAS (Texas Accessibility Standards)", "Environmental review", "Stormwater management (TCEQ)", "Parking analysis"],
  ...
  },
  {
    ...
    commercialRequirements: ["Drawings signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-sealed structural plans", "MEP documents", "Fire protection plans", "ADA compliance", "Special inspection program", "Environmental review", "Stormwater management"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-stamped structural plans", "MEP plans", "Fire protection plans", "ADA compliance", "SEPA environmental review", "Stormwater management", "Shoreline Management Act compliance (if applicable)"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-sealed structural engineering", "MEP plans and specifications", "Fire protection plans", "ADA and MAAB accessibility compliance", "Energy code compliance", "Environmental review (MEPA for larger projects)"],
    ...
    timeline: "Residential: 1–4 weeks. Commercial: 4–12 weeks.",
    inspections: ["Foundation", "Framing", "Rough-in inspections", "Insulation", "Final"],
    codes: ["780 CMR (MA State Building Code)", "Based on IBC/IRC 2015 with MA amendments", "MA Stretch Energy Code (mandatory in many communities)", "NEC 2020", "248 CMR (Plumbing Code)", "MAAB accessibility regulations"],
    specialNotes: ["Stretch Energy Code adopted by 300+ communities (exceeds base energy code)", "MAAB accessibility regulations", "Wetlands Protection Act — Conservation Commission review", "Historic district considerations (many in MA)", "Title V septic system requirements"]
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-sealed structural documents", "MEP plans", "Fire protection plans", "Barrier-free design compliance", "Environmental review", "Plan review by state-licensed plan reviewer"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-sealed structural plans", "MEP plans", "Fire protection plans", "ADA and MN accessibility compliance", "Energy code compliance", "Environmental review (EAW/EIS if applicable)"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-sealed structural plans", "MEP plans", "Fire protection plans", "ADA compliance", "Soils report", "Traffic study (if required)"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-sealed structural plans", "MEP plans", "Fire and life safety plans", "ADA and OR accessibility compliance", "Energy code compliance", "Environmental review"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-sealed structural plans", "MEP documents", "Fire protection plans", "ADA/accessibility compliance", "State Fire Marshal review"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional, submitted to state", "PE-sealed structural plans", "MEP plans", "Fire protection plans", "ADA compliance", "State plan review through IDHS"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-sealed structural plans", "MEP plans", "Fire protection plans", "ADA compliance"],
  ...
  },
  {
    ...
    commercialRequirements: ["Plans signed and sealed by a licensed design professional (per jurisdiction requirements)", "PE-sealed structural plans", "MEP documents", "Fire protection plans", "ADA compliance", "Stormwater management", "Environmental review"],
